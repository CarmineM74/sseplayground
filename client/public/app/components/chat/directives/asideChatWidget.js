define(['components/chat/module','jquery'], function (module, $) {
    ...
    */
    ...
    module.registerDirective('asideChatWidget', function (ChatApi) {
        return {
            restrict: 'A',
            replace: true,
            templateUrl: 'app/components/chat/directives/aside-chat-widget.tpl.html',
            link: link
        }
    });
});
