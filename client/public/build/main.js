...
define('layout/actions/resetWidgets',['layout/module'], function (module) {
    ...
    module.directive('resetWidgets', ["$state", function($state){
...
define('layout/actions/searchMobile',['layout/module'], function (module) {
    ...
    module.directive('searchMobile', function () {
        return {
            restrict: 'A',
...
define('layout/directives/smartInclude',['layout/module'], function(module){
    ...
    return module.directive('smartInclude', function () {
            return {
                replace: true,
                restrict: 'A',
...
define('layout/directives/smartDeviceDetect',['layout/module'], function (module) {
    ...
    module.directive('smartDeviceDetect', function () {
        return {
            restrict: 'A',
...
define('layout/directives/smartFastClick',['layout/module' , 'require', 'fastclick'], function (module, require) {
    ...
    module.directive('smartFastClick', function () {
...
define('layout/directives/smartLayout',['layout/module', 'lodash'], function (module, _) {
    ...
    module.directive('smartLayout', ["$rootScope", "$timeout", "$interval", "$q", "SmartCss", function ($rootScope, $timeout, $interval, $q, SmartCss) {
...
define('layout/directives/smartSpeech',['layout/module', 'jquery'], function (module, $) {
    ...
    module.directive('speechRecognition', ["$log", function ($log) {
...
define('layout/directives/smartRouterAnimationWrap',['layout/module', 'lodash'], function (module, _) {
    ...
    module.directive('smartRouterAnimationWrap', ["$rootScope", "$timeout", function ($rootScope,$timeout) {
        return {
            restrict: 'A',
            compile: function (element, attributes) {
...
define('layout/directives/smartFitAppView',['layout/module', 'lodash'], function (module, _) {
    ...
    module.directive('smartFitAppView', ["$rootScope", "SmartCss", function ($rootScope, SmartCss) {
        return {
            restrict: 'A',
            compile: function (element, attributes) {
...
define('layout/directives/radioToggle',['layout/module'], function (module) {
    ...
    */
    ...
    module.directive('radioToggle', ["$log", function ($log) {
      return {
        scope: {
          model: "=ngModel",
          value: "@value"
...
define('layout/directives/dismisser',['layout/module'], function (module) {
    ...
    module.directive('dismisser', function () {
        return {
            restrict: 'A',
            compile: function (element) {
...
define('layout/directives/smartMenu',['layout/module', 'jquery'], function (module) {
    ...
    module.directive('smartMenu', ["$state", "$rootScope", function ($state, $rootScope) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
                var $body = $('body');
...
define('layout/directives/bigBreadcrumbs',['layout/module', 'lodash'], function (module, _) {
    ...
    module.directive('bigBreadcrumbs', function () {
        return {
            restrict: 'E',
            replace: true,
...
define('layout/directives/stateBreadcrumbs',['layout/module'], function (module) {
    ...
    module.directive('stateBreadcrumbs', ["$rootScope", "$state", function ($rootScope, $state) {
...
define('layout/directives/smartPageTitle',['layout/module'], function (module) {
    ...
    module.directive('smartPageTitle', ["$rootScope", "$timeout", function ($rootScope, $timeout) {
        return {
            restrict: 'A',
            compile: function (element, attributes) {
...
define('layout/service/SmartCss',['layout/module', 'lodash'], function (module, _) {
    ...
    module.factory('SmartCss', ["$rootScope", "$timeout", function ($rootScope, $timeout) {
...
define('dashboard/module',['angular', 'ocLazyLoad', 'angular-ui-router', 'angular-resource'], function(ng, couchPotato) {
