...
module.exports = function(grunt) {
  ...
  options = {
    ...
    coffee: {
      compile: {
        files: {
          "tmp/output_coffee.js": ["src/coffee/extensions/string.coffee", "src/coffee/extensions/lodash.coffee", "src/coffee/module.coffee", "src/coffee/providers/*.coffee", "src/coffee/extensions/google.maps.coffee", "src/coffee/directives/api/utils/*.coffee", "src/coffee/directives/api/managers/*.coffee", "src/coffee/controllers/polyline-display.js", "src/coffee/utils/*.coffee", "src/coffee/directives/api/options/**/*.coffee", "src/coffee/directives/api/models/child/*.coffee", "src/coffee/directives/api/models/parent/*.coffee", "src/coffee/directives/api/*.coffee", "src/coffee/directives/map.coffee", "src/coffee/directives/marker.coffee", "src/coffee/directives/markers.coffee", "src/coffee/directives/label.coffee", "src/coffee/directives/polygon.coffee", "src/coffee/directives/circle.coffee", "src/coffee/directives/polyline*.coffee", "src/coffee/directives/rectangle.coffee", "src/coffee/directives/window.coffee", "src/coffee/directives/windows.coffee", "src/coffee/directives/layer.coffee", "src/coffee/directives/control.coffee", "src/coffee/directives/*.coffee"],
          "tmp/string.js": "src/coffee/extensions/string.coffee",
    ...
    concat: {
      ...
      dist: {
        src: ["tmp/output_coffee.js", "tmp/wrapped_uuid.js", "tmp/wrapped_libs.js", "src/js/**/*.js", "src/js/**/**/*.js", "src/js/**/**/**/*.js", "!src/js/wrapped/*.js"],
        dest: "tmp/output.js"
      },
      libs: {
        src: ["lib/*.js"],
